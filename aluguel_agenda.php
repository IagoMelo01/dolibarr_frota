...
/**
 *  \file       aluguel_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on Aluguel
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Aluguel")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Aluguel"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_aluguel_'.$object->id;
