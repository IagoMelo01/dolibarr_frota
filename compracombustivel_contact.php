...
/**
 *  \file       compracombustivel_contact.php
 *  \ingroup    frota
 *  \brief      Tab for contacts linked to CompraCombustivel
 */
...
$title = $langs->trans("CompraCombustivel")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("CompraCombustivel"), -1, $object->picto);
