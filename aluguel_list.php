...
/**
 *   	\file       aluguel_list.php
 *		\ingroup    frota
 *		\brief      List page for aluguel
 */
...
require_once __DIR__.'/class/aluguel.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('frota', 'aluguel', 'write');
	$permissiontodelete = $user->hasRight('frota', 'aluguel', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("Aluguels");
//$help_url = "EN:Module_Aluguel|FR:Module_Aluguel_FR|ES:Módulo_Aluguel";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/frota/aluguel_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/frota/aluguel_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendAluguelRef";
$modelmail = "aluguel";
$objecttmp = new Aluguel($db);
