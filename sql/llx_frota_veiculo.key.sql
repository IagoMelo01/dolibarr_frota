...
ALTER TABLE llx_frota_veiculo ADD INDEX idx_frota_veiculo_rowid (rowid);
...
ALTER TABLE llx_frota_veiculo ADD CONSTRAINT llx_frota_veiculo_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
...
--ALTER TABLE llx_frota_veiculo ADD CONSTRAINT llx_frota_veiculo_fk_field FOREIGN KEY (fk_field) REFERENCES llx_frota_myotherobject(rowid);
