...
/**
 *  \file       compracombustivel_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on CompraCombustivel
 */
...
if ($object->id > 0) {
	$title = $langs->trans("CompraCombustivel")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("CompraCombustivel"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_compracombustivel_'.$object->id;
