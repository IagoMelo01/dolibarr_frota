...
/**
 *   	\file       compracombustivel_list.php
 *		\ingroup    frota
 *		\brief      List page for compracombustivel
 */
...
require_once __DIR__.'/class/compracombustivel.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('frota', 'compracombustivel', 'write');
	$permissiontodelete = $user->hasRight('frota', 'compracombustivel', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'CompraCombustivel';
	$objectlabel = 'CompraCombustivel';
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/frota/compracombustivel_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/frota/compracombustivel_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendCompraCombustivelRef";
$modelmail = "compracombustivel";
$objecttmp = new CompraCombustivel($db);
