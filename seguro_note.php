...
/**
 *  \file       seguro_note.php
 *  \ingroup    frota
 *  \brief      Tab for notes on Seguro
 */
...
$title = $langs->trans('Seguro').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Seguro"), -1, $object->picto);
