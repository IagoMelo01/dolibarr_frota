...
/**
 *  \file       manutencao_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on Manutencao
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Manutencao")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Manutencao"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_manutencao_'.$object->id;
