...
/**
 *   	\file       reservatorio_list.php
 *		\ingroup    frota
 *		\brief      List page for reservatorio
 */
...
require_once __DIR__.'/class/reservatorio.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('frota', 'reservatorio', 'write');
	$permissiontodelete = $user->hasRight('frota', 'reservatorio', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Reservatorio';
	$objectlabel = 'Reservatorio';
...
$title = $langs->trans("Reservatorios");
//$help_url = "EN:Module_Reservatorio|FR:Module_Reservatorio_FR|ES:Módulo_Reservatorio";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/frota/reservatorio_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/frota/reservatorio_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendReservatorioRef";
$modelmail = "reservatorio";
$objecttmp = new Reservatorio($db);
