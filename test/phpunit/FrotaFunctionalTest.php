...
/**
 * \file    test/phpunit/FrotaFunctionalTest.php
 * \ingroup frota
 ...
 * @package Testfrota
 */
class FrotaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/frota/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('frota/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/frota/admin/about.php');
		$this->authenticate();
		return $this->assertContains('frota/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('frotawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFrota_FrotaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFrota_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
