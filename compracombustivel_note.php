...
/**
 *  \file       compracombustivel_note.php
 *  \ingroup    frota
 *  \brief      Tab for notes on CompraCombustivel
 */
...
$title = $langs->trans('CompraCombustivel').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("CompraCombustivel"), -1, $object->picto);
