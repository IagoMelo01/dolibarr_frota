...
/**
 *  \file       reservatorio_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on Reservatorio
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Reservatorio")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Reservatorio"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_reservatorio_'.$object->id;
