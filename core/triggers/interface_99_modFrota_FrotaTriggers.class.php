...
/**
 * \file    core/triggers/interface_99_modFrota_FrotaTriggers.class.php
 * \ingroup frota
 ...
 *      - interface_99_modFrota_MyTrigger.class.php
...
require_once DOL_DOCUMENT_ROOT.'/custom/frota/class/compracombustivel.class.php';
...
/**
 *  Class of triggers for Frota module
 */
class InterfaceFrotaTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Frota triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'frota@frota';
	}
