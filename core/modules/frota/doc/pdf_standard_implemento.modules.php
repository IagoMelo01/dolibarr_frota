...
/**
 *  \file       core/modules/frota/doc/pdf_standard.modules.php
 *  \ingroup    frota
...
/**
 *	Class to manage PDF template standard_implemento
 */
class pdf_standard_implemento extends ModelePDFImplemento
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (getDolGlobalString('MAIN_GENERATE_IMPLEMENTO_WITH_PICTURE'))
		{
		...
		*/
		...
		if ($conf->frota->dir_output.'/implemento') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->frota->dir_output.'/implemento';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->frota->dir_output.'/implemento/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('FROTA_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('FROTA_DRAFT_WATERMARK')));
		}
