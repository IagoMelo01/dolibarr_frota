...
/**
 *	Class to manage PDF template standard_veiculo
 */
class pdf_standard_veiculo extends ModelePDFVeiculo
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (getDolGlobalString('MAIN_GENERATE_VEICULO_WITH_PICTURE'))
		{
		...
		*/
		...
		if ($conf->frota->dir_output.'/veiculo') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->frota->dir_output.'/veiculo';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->frota->dir_output.'/veiculo/'.$objectref;
