...
/**
 *	Class to manage PDF template standard_reservatorio
 */
class pdf_standard_reservatorio extends ModelePDFReservatorio
{
	/**
	 ...
	 *
	 *  @param		Reservatorio	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Reservatorio	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('FROTA_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
