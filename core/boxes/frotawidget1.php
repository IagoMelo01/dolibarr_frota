...
/**
 * \file    frota/core/boxes/frotawidget1.php
 * \ingroup frota
 * \brief   Widget provided by Frota
 *
 ...
 */
class frotawidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "frotabox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "frota@frota";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "frota@frota"));
		...
		// $this->hidden = !$user->hasRight('frota', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/frota/class/frota.class.php");

		// Populate the head at runtime
		$text = $langs->trans("FrotaBoxDescription", $max);
