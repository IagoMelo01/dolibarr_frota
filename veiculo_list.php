...
/**
 *   	\file       veiculo_list.php
 *		\ingroup    frota
 *		\brief      List page for veiculo
 */
...
$hookmanager->initHooks(array('veiculolist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('frota', 'veiculo', 'write');
	$permissiontodelete = $user->hasRight('frota', 'veiculo', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
//$help_url = "EN:Module_Veiculo|FR:Module_Veiculo_FR|ES:Módulo_Veiculo";
$help_url = '';
$title = $langs->trans("Veiculos");
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/frota/veiculo_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/frota/veiculo_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendVeiculoRef";
$modelmail = "veiculo";
$objecttmp = new Veiculo($db);
