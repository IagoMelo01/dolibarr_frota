...
/**
 *  \file       seguro_contact.php
 *  \ingroup    frota
 *  \brief      Tab for contacts linked to Seguro
 */
...
$title = $langs->trans("Seguro")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Seguro"), -1, $object->picto);
