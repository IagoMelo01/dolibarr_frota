...
/**
 *  \file       seguro_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on Seguro
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Seguro")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Seguro"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_seguro_'.$object->id;
