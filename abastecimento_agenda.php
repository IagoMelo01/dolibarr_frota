...
/**
 *  \file       abastecimento_agenda.php
 *  \ingroup    frota
 *  \brief      Tab of events on Abastecimento
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Abastecimento")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Abastecimento"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_abastecimento_'.$object->id;
